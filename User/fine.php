...
<div id="mySidenav" class="sidenav">
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
    ...
    <div class="container">
        ...
        ?>
        <br><br> <div class="h">
    <button onclick="window.location.href='user-dashboard.php'" style="padding: 10px 20px; background-color: #6db6b9e6; color: white; border: none; border-radius: 5px; cursor: pointer;">
        Back To Dashboard
    </button>
</div>
    </div>
